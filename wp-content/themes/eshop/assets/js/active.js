...
(function($) {
	...
	$('.product-single-images').owlCarousel({
		loop: true,
		nav: true,
		dots: false,
		items: 1,
	...
	$('.product-single-thumbnails').owlCarousel({
		loop: true,
		nav: false,
		dots: false,
		items: 4,
...
$('.product-action-2 .add_to_cart_button').on('click', function () {
	showAlert('Товар добавлен в корзину');
});
})(jQuery);
